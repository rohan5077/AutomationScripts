...
function ab(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=a.match(Q)[1]||null,e=R(a.match(Q)[3]||null);d&&e?(d=c,c=a.match(Q),d=d.match(Q),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?R(c.match(Q)[3]||null)==e&&(Number(c.match(Q)[4]||null)||null)==(Number(a.match(Q)[4]||null)||null):!0;for(var f in Za)(d=T(Za[f]))&&(c||bb(a,f))&&(b[f]=d);if(c||bb(a,"X-YouTube-Utc-Offset"))b["X-YouTube-Utc-Offset"]=-(new Date).getTimezoneOffset();return b}
function bb(a,b){var c=T("CORS_HEADER_WHITELIST")||{},d=R(a.match(Q)[3]||null);return d?(c=c[d])?0<=ja(c,b):!1:!0}
function cb(a){var b=a.format||"JSON";var c=db("//googleads.g.doubleclick.net/pagead/id",a);var d=eb(c,a),e=!1,f,g=fb(c,function(c){if(!e){e=!0;f&&window.clearTimeout(f);var d=Wa(c),g=null,h=400<=c.status&&500>c.status,qb=500<=c.status&&600>c.status;if(d||h||qb)g=gb(b,c,a.F);if(d)a:if(c&&204==c.status)d=!0;else{switch(b){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};h=a.context||r;d?a.l&&a.l.call(h,c,g):a.onError&&a.onError.call(h,c,g);a.A&&a.A.call(h,
...
return g}
function db(a,b){b.H&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=T("XSRF_FIELD_NAME",void 0),d=b.J;if(d){d[c]&&delete d[c];var e=d||{};c=a.split("#",2);d=c[0];c=1<c.length?"#"+c[1]:"";var f=d.split("?",2);d=f[0];f=Ya(f[1]||"");for(var g in e)f[g]=e[g];g=Qa(f);if(g){e=d.indexOf("#");0>e&&(e=d.length);f=d.indexOf("?");if(0>f||f>e){f=e;var h=""}else h=d.substring(f+1,e);d=[d.substr(0,f),h,d.substr(e)];e=d[1];d[1]=g?e?
e+"&"+g:g:e;g=d[0]+(d[1]?"?"+d[1]:"")+d[2]}else g=d;a=g+c}return a}
function eb(a,b){var c=T("XSRF_FIELD_NAME",void 0),d=T("XSRF_TOKEN",void 0),e=b.I||"",f=b.o,g=T("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.G||R(a.match(Q)[3]||null)&&!b.withCredentials&&R(a.match(Q)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.o&&b.o[g]||(f||(f={}),f[c]=d);f&&u(e)&&(e=Ya(e),ta(e,f),e=b.B&&"JSON"==b.B?JSON.stringify(e):Qa(e));if(!(c=e)&&(c=f)){a:{for(var k in f){f=!1;break a}f=!0}c=!f}!$a&&c&&"POST"!=
b.method&&($a=!0,Ta(Error("AJAX request with postData should use POST")));return e}
function gb(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?hb(b):null)d={},ka(b.getElementsByTagName("*"),function(a){d[a.tagName]=ib(a)})}c&&jb(d);
return d}
function jb(a){if(da(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);c?a[b]=new Aa:jb(a[b])}}
function hb(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function ib(a){var b="";ka(a.childNodes,function(a){b+=a.nodeValue});
return b}
function fb(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&Sa(b)(k)}
...
;function kb(){var a=qa(),b;return O(new L(function(c,d){a.l=function(a){Wa(a)?c(a):d(new U("Request failed, status="+a.status,"net.badstatus",a))};
a.onError=function(a){d(new U("Unknown request error","net.unknown",a))};
a.m=function(a){d(new U("Request timed out","net.timeout",a))};
b=cb(a)}),function(a){a instanceof P&&b.abort();
return N(a)})}
...
V.prototype.then=function(a,b,c){return this.c?this.c.then(a,b,c):1===this.a&&a?(a=a.call(c,this.b),K(a)?a:lb(a)):2===this.a&&b?(a=b.call(c,this.b),K(a)?a:mb(a)):this};
Ba(V);function mb(a){var b=new V;a=void 0===a?null:a;b.a=2;b.b=void 0===a?null:a;return b}
...
q(X,B);X.prototype.name="BiscottiMissingError";var ra={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Y=null;function nb(){if("1"===pa(T("PLAYER_CONFIG",{}),"args","privembed"))return N(Error("Biscotti ID is not available in private embed mode"));Y||(Y=O(kb().then(ob),function(a){return pb(2,a)}));
return Y}
function ob(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new X;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new X;a=a.id;rb(a);Y=lb(a);sb(18E5,2);return a}
function pb(a,b){var c=new W(b);rb("");Y=mb(c);0<a&&sb(12E4,a-1);throw c;}
function sb(a,b){Xa(function(){O(kb().then(ob,function(a){return pb(b,a)}),x)},a)}
function rb(a){v("yt.ads.biscotti.lastId_",a)}
;w("yt.ads.biscotti.getId_")||v("yt.ads.biscotti.getId_",nb);var Z;try{var tb=w("yt.ads.biscotti.getId_");Z=tb?tb():nb()}catch(a){Z=N(a)}O(Z,x);}).call(this);
